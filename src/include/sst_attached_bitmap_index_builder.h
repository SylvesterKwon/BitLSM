...
class SstAttachedBitmapIndexBuilder : public TablePropertiesCollector {
   private:
   ...
   public:
    ...
    Status Finish(UserCollectedProperties* properties) override {
        ...
        properties->insert(
            {"block_kv_cnt_psum", serialized_block_kv_cnt_psum_});

        return Status::OK();
    }

    const char* Name() const override {
        return "SstAttachedBitmapIndexBuilder";
    }
...
class SstAttachedBitmapIndexBuilderFactory
    : public TablePropertiesCollectorFactory {
   public:
    TablePropertiesCollector* CreateTablePropertiesCollector(
        TablePropertiesCollectorFactory::Context context) override {
        return new SstAttachedBitmapIndexBuilder();
    }

    const char* Name() const override {
        return "SstAttachedBitmapIndexBuilderFactory";
    }
};
